...
WebUI.setText(findTestObject('Object Repository/Page_Amazon.in/input_field-keywords'), 'EMKARY')

WebUI.click(findTestObject('Object Repository/Page_Amazon.in/button_Continue shopping'))

WebUI.setText(findTestObject('Object Repository/Page_Amazon Sign In/input_email'), '9644307700')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Amazon Sign In/input_password'), '9XZjq51hSuGIo5DsRdiJ+g==')

WebUI.click(findTestObject('Object Repository/Page_Amazon Sign In/inputsignInSubmit'))

WebUI.click(findTestObject('Object Repository/Page_Book Store Online  Buy Books Online at_0a68ca/a_Books'))
