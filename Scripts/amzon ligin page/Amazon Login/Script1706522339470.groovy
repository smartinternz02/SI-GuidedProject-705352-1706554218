...
WebUI.click(findTestObject('Object Repository/Amazon login page/Page_Amazon.in/button_Continue shopping'))

WebUI.setText(findTestObject('Object Repository/Amazon login page/Page_Amazon Sign In/input_email'), '9644307700')

WebUI.click(findTestObject('Object Repository/Amazon login page/Page_Amazon Sign In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon login page/Page_Amazon Sign In/input_password'), '9XZjq51hSuGIo5DsRdiJ+g==')

WebUI.click(findTestObject('Object Repository/Amazon login page/Page_Amazon Sign In/inputsignInSubmit'))
